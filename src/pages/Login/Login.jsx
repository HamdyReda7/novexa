...
import NovexaLogo from "../../components/NovexaLogo/NovexaLogo";
import "./Login.css";
                ...
                <form onSubmit={handleSubmit} className="login-form-element">
                    ...
                    <div className="form-group-field">
                        ...
                        <div className="input-with-icon-wrapper">
                            <FiMail className="input-field-icon" size={18} aria-hidden="true" />
                            <input 
                                type="email" 
                                id="login-email" 
                    ...
                    <div className="form-group-field">
                        ...
                        <div className="input-with-icon-wrapper">
                            <FiLock className="input-field-icon" size={18} aria-hidden="true" />
                            <input 
                                type="password" 
                                id="login-password" 
