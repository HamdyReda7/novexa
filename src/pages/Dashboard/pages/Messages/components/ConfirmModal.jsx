        ...
        <div className="modal-backdrop-overlay" onClick={onClose}>
            <div className="modal-container-card confirm-modal-width" onClick={(e) => e.stopPropagation()}>
                <div className="confirm-modal-header">
                    <h3>{t("dashboard.messages.confirmDeleteTitle") || "Delete Request"}</h3>
                </div>
                <div className="confirm-modal-body">
                    <p>{t("dashboard.messages.confirmDeleteText") || "Are you sure you want to delete this order request? This action cannot be undone."}</p>
                </div>
