export default {
    ...
    hero: {
        ...
        titleLine1: "We Code.",
        titleLine2: "We Innovate.",
        titleLine3: "We Elevate.",
        description: "Building powerful digital solutions that drive your business forward. Custom software architecture, mobile apps, and enterprise systems built for speed and scale.",
    ...
    testimonials: {
        ...
        description: "See how top enterprise companies and startups scale their digital platforms with Novexa.",
        items: [
            {
                name: "Alexander Wright",
                role: "CTO at Nexus Cloud",
                quote: "Novexa engineered our entire cloud microservice architecture. Their attention to performance, security, and UI precision was unmatched. We saw a 140% surge in system throughput.",
            },
            {
                name: "Sarah Lin",
                role: "Head of Product at OmniPay",
                quote: "Working with Novexa felt like having an elite Silicon Valley dev team in-house. They delivered our iOS and Android fintech application 3 weeks ahead of schedule.",
            },
            {
                name: "Marcus Vance",
                role: "Founder & CEO at Apex Logistics",
                quote: "Our custom ERP platform rebuilt by Novexa automated 80% of our daily manual dispatch workflows. The Return on Investment was realized within the first quarter.",
            }
        ]
    },
    contact: {
